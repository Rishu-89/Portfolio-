...
//                 <div key={index} className="flex flex-wrap mb-4 cursor-pointer lg:justify-center" >
//                      <motion.div
...
//                         <a href={project.link}>{project.title}</a></h6>
//                         {/* <a href={project.link} className="mb-2 font-semibold">Visit</a> */}
//                         </div>
